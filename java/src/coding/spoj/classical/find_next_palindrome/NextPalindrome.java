package coding.spoj.classical.find_next_palindrome;
...
public class NextPalindrome {
	...
	public static void main(String[] args) {
		...
		for (String string : strArray) {
			...
			System.out.println(getNextPallindrome(string));
	...
	private static char[] getNextPallindrome(String inputString) {
